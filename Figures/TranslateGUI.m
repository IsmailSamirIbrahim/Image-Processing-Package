function varargout = TranslateGUI(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TranslateGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @TranslateGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TranslateGUI is made visible.
function TranslateGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for TranslateGUI
...
function varargout = TranslateGUI_OutputFcn(hObject, eventdata, handles) 
...
transval=get(handles.edit1 ,'String');
offset=str2num(transval);
...
handles.Result=Translate(handles.Image,Value);
axes(handles.axes2);
imshow(handles.Result);
guidata(hObject, handles);
